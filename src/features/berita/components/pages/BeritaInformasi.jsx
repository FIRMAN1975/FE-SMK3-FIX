    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ fontWeight: 700, fontSize: 16, color: "#0f1f4b" }}>
            ...
            <>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ fontSize: 15, color: "#374151" }}>
                  📅 <strong>Tanggal:</strong> {formatTgl(data.date)}
                </div>
                {data.location && (
                  <div style={{ fontSize: 15, color: "#374151" }}>
          ...
          {type === "prestasi" && (
            <>
              ...
              <div style={{ display: "flex", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
                <span style={{ padding: "4px 14px", background: "#fef3c7", color: "#b45309", borderRadius: 20, fontSize: 13, fontWeight: 700, textTransform: "capitalize" }}>
                  🌐 {data.tingkat}
                </span>
                <span style={{ padding: "4px 14px", background: "#e0f2fe", color: "#0369a1", borderRadius: 20, fontSize: 13, fontWeight: 700 }}>
                  📅 {data.tahun}
                </span>
              </div>
              {data.keterangan && (
                      ...
                      >
                        <div className="bp-berita-body">
                          <div className="bp-berita-meta">
                            ...
                            <span className="bp-berita-date">📅 {p.tahun}</span>
                          </div>
