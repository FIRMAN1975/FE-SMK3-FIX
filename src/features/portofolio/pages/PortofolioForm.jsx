        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'center', border: '2px dashed #d1d5db', padding: '20px', borderRadius: '8px', backgroundColor: '#f9fafb' }}>
                ...
                {imagePreview ? (
                  ...
                  <div style={{ fontSize: '40px', color: '#9ca3af' }}>🖼️</div>
                )}
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '10px' }}>
              <button type="button" onClick={() => navigate('/portofolio')} disabled={submitting} style={{ backgroundColor: 'transparent', color: '#4b5563', border: '1px solid #d1d5db', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontSize: '14px' }}>Batal</button>
